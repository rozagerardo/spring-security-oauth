...
public class Oauth2ClientLiveTest {
    ...
    private final String resourceUrl = "http://localhost:8082/new-client/projects";
    private final String clientAuthorizationUri = "http://localhost:8082/new-client/oauth2/authorization/custom";
