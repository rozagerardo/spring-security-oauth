...
public class AuthorizationServerLiveTest {
    ...
    private String obtainAccessToken() {
        ...
        final String authorizeUrl = "http://localhost:8083/auth/realms/baeldung/protocol/openid-connect/auth?response_type=code&client_id=newClient&scope=read&redirect_uri=" + redirectUrl;
