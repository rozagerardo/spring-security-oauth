...
class PopupWindow extends React.Component {
  ...
  requestAccessTokenFn = () => {
    const { tokenDomain, redirectUri, tokenEndpoint, clientId, audience } = CONFIGS[this.state.provider];
    ...
    var self = this;
    axios.post(tokenUrl, new URLSearchParams(tokenRequestBody), { headers })
